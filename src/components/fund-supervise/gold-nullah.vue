<template>
	<div>
		...
		<el-table
			...
			<el-table-column prop="userId" label="金币流水号"></el-table-column>
			<el-table-column prop="gatheringId" label="用户昵称"></el-table-column>
			<el-table-column prop="income" label="用户ID"></el-table-column>
			<el-table-column prop="balance" label="收支（金币）"></el-table-column>
			<el-table-column prop="balance" label="账户余额（金币）"></el-table-column>
