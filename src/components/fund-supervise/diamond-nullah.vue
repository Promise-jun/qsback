	...
	<div>
		<el-form :inline="true" :model="formObj" class="demo-form-inline">
		  ...
		  <el-form-item label="流水号">
		    <el-input v-model="formObj.userId" placeholder="请输入流水号"></el-input>
		  </el-form-item>
		...
		<el-table
			...
			<el-table-column prop="createTm" label="入账时间">
		      <template slot-scope="scope">{{ scope.row.createTm | formatDate }}</template>
		    </el-table-column>
			<el-table-column prop="userId" label="流水号"></el-table-column>
			<el-table-column prop="gatheringId" label="用户昵称"></el-table-column>
			<el-table-column prop="income" label="用户ID"></el-table-column>
			<el-table-column prop="balance" label="转化比例"></el-table-column>
			<el-table-column prop="balance" label="收支（钻石）"></el-table-column>
		    <el-table-column prop="payerId" label="账户余额（钻石）"></el-table-column>
		    <el-table-column prop="payerId" label="类型"></el-table-column>
		    <el-table-column prop="payerId" label="备注"></el-table-column>
		    <el-table-column prop="payerId" label="对方用户昵称"></el-table-column>
		    <el-table-column prop="payerId" label="对方用户ID"></el-table-column>
		</el-table>
