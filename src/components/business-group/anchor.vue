<template>
	<div>
		<el-table
		    ...
		    <el-table-column label="操作">
		    	<template slot-scope="scope">
		    		<el-tooltip content="删除" placement="top" v-hasPermission="92">
		...
		<el-row>
		  <el-col :span="12">
		  	<el-button v-hasPermission="91" type="primary" size="small" icon="el-icon-circle-plus" @click="add">添加用户</el-button>
		  	<el-button v-hasPermission="93" type="primary" size="small" icon="el-icon-delete" @click="batchDel">批量删除</el-button>
		  </el-col>
		  <el-col :span="12">
		  	<page-num
		...
		<!-- 添加主播 -->
		<el-dialog title="添加主播" :visible.sync="visibleDialog" width="30%">
