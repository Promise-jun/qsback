<template>
	<div>
		<el-table
		    ...
		    <el-table-column label="操作">
		    	<template slot-scope="scope">
		    		<el-tooltip content="删除" placement="top" v-hasPermission="84">
		...
		<el-row>
		  <el-col :span="12">
		  	<el-button v-hasPermission="83" type="primary" size="small" icon="el-icon-circle-plus" @click="add">添加用户</el-button>
		  	<el-button v-hasPermission="85" type="primary" size="small" icon="el-icon-delete" @click="batchDel">批量删除</el-button>
		  </el-col>
		  <el-col :span="12">
		  	<page-num
	...
	export default {
		...
		methods: {
		    ...
		    batchDel() {
		    	...
		    	this.$confirm('确定要批量删除选中的咨询师吗?', '提示', {
		          	confirmButtonText: '确定',
		          	cancelButtonText: '取消',
		          	type: 'warning'
		        }).then(() => {
