    	...
    	<el-row :gutter="20">
		  	<el-col :span="12" :offset="1">
		  		<el-form :model="formData" :rules="rules" ref="ruleForm" label-width="150px" class="demo-ruleForm">
		  			<el-form-item label="礼物名称" prop="userAccount">
					    <el-input v-model="formData.userAccount" autocomplete="off" placeholder="请输入礼物名称"></el-input>
					</el-form-item>
					<el-form-item label="礼物价格" prop="userAccount">
					    <el-input v-model="formData.userAccount" autocomplete="off" placeholder="请输入礼物价格"></el-input><span> 金币</span>
					</el-form-item>
